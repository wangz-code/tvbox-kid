...
public class Aidi extends Spider {
    ...
    public String readLongStringFromAssets(Context context, String fileName) {
        try {
    ...
    public String homeContent(boolean filter) {
        System.out.println("homeContent 调用"+filter);

        try {
            Document doc = Jsoup.parse(OkHttpUtil.string(siteUrl, getHeaders(siteUrl)));
//            String longStr = readLongStringFromAssets(ctx, "index.html");
//            Document doc = Jsoup.parse(longStr);
    ...
    public String categoryContent(String tid, String pg, boolean filter, HashMap<String, String> extend) {
        System.out.println("categoryContent 调用");
